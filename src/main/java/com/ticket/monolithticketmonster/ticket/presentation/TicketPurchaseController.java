...
public class TicketPurchaseController {
  ...
  public ResponseEntity<?> buyTicket(
    ...
    logger.info("User {} is buying ticket for concert with id: {}", user.getUserId().toString(), concertId);
    var ticket = ticketPurchaseUseCase.purchaseTicket(new ConcertId(concertId), new UserId(user.getUserId()));
